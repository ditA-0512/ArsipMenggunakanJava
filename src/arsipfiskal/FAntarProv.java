 ...
 * @author user
 */
public class FAntarProv extends javax.swing.JFrame {
    Statement st;
    ResultSet rs;
    Koneksi Koneksi;
    private String Tgl;
    ...
    try{
        st=Koneksi.con.createStatement();
        String query="SELECT * FROM tb_provinsi where no_surat like  "+txtCari.getText()+"%'"
    ...
    private void initComponents() {
        ...
        jmBeranda = new javax.swing.JMenu();
        ...
        txtBatal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/if_button_cancel_1939.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtBatal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtBatal, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jmBeranda.setText("Home");
        jmBeranda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmBerandaActionPerformed(evt);
            }
        });
        ...
        jmBeranda.add(jMenuItem3);

        jMenuBar1.add(jmBeranda);
    ...
    private void jmBerandaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmBerandaActionPerformed
        // TODO add your handling code here:
        new FBeranda().show();
        this.dispose();
    }//GEN-LAST:event_jmBerandaActionPerformed
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
       ...
       // if(dtTanggalPembelian.getDate()!=null){
            ...
            Tgl=sdf.format(dtTgl.getDate());
             ...
             String sqlRev="update tb_provinsi set tanggal='"+Tgl+"',nopol='"+txtNoPol.getText()
                    +"',jenis='"+txtJenKen.getText()+"',cc='"+txtCC.getText()+"',warna='"+txtWarna.getText()
                     +"',tujuan='"+txtTujuan.getText()
                    +"'where no_surat='"+txtNoSurat.getText()+"'";
            java.sql.Connection konekRev=FAntarProv.koneksiDb();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      try
		{
			String namaFile = "src:/arsipfiskal/report1.jasper";
			String Driver = "com.mysql.jdbc.Driver";
			String Koneksi = "jdbc:mysql://localhost/db_fiskal";
			String user = "root";
			String password = "";
			...
			Connection KoneksiDB = DriverManager.getConnection(Koneksi,user,password);
			File file = new File(namaFile);
			JasperReport jasperReport = (JasperReport)JRLoader.loadObject(file.getPath());
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hash, KoneksiDB);
    ...
    private void txtBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBatalActionPerformed
        // TODO add your handling code here:
         try{
            String sqlHapus = "delete from tb_provinsi where no_surat = '"+txtNoSurat.getText()+"'";
            java.sql.Connection konekHapus = FAntarProv.koneksiDb();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FAntarProv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JMenu jmBeranda;
