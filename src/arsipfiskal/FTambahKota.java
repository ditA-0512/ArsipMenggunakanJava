...
import arsipfiskal.FAntarKota;

/**
 *
 * @author user
 */
public class FTambahKota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Surat Fiskal Antar Kota/Kabupaten");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
       ...
       // if(dtTanggalPembelian.getDate()!=null){
            ...
            Tgl=sdf.format(dtTgl.getDate());
             ...
             String sqlSimpan="insert into tb_kota values('"+txtNoSurat.getText()+"','"
                    +Tgl+"','"+txtNoPol.getText()+"','"+txtJenKen.getText()+"','"
                    +txtCC.getText()+"','"+txtWarna.getText()+"','"
                    +txtTujuan.getText()+"')";
            java.sql.Connection konekSimpan=FTambahKota.koneksiDb();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTambahKota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FTambahKota().setVisible(true);
            }
        });
    }
